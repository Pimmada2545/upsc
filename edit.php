        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="home.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Device</a> <br>
                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <div class="form-label" aria-hidden="true" style="text-align:left;width:100%;">DateTime
                                    <input type="text" class="form-control" name="d_record" value="<?php  echo $data['d_record'];?>">
                                    
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="form-label" aria-hidden="true" style="text-align:left;width:100%;">ID Employee
                                    <input type="text" class="form-control" name="d_idemp" value="<?php  echo $data['d_idemp'];?>">
                                    </div>
                                </div>
...
if (isset($_POST['submit'])) {
  ...
  $sql_select = "SELECT `d_upsname`, `d_model`, `d_company`, `d_token`, `d_location`,`d_remark`,`d_record`,`d_idemp` FROM `devices`";
...
`d_token`='$d_token',`d_location`='$d_location',`d_remark`='$d_remark',`d_record`='$d_record',`d_idemp`='$d_idemp'
