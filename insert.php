                    ...
                    <div class="card">
                        ...
                        <form method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="d_record" CURENCE_TIMESTAMP>
                                    
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="form-label" aria-hidden="true" style="text-align:left;width:100%;">ID Employee
                                    <input type="text" class="form-control" name="d_idemp">
                                    </div>
                                </div>
...
$sql_insert = "INSERT INTO `devices`(`d_upsname`, `d_model`, `d_company`, `d_token`, `d_location`, `d_remark`, `d_record`, `d_idemp`) VALUES
             ('$d_upsname', '$d_model', '$d_company','$d_token', '$d_location','$d_remark', '$d_record','$d_idemp')";
